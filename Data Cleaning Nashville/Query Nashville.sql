...
-- The first thing that we can see is that the SaleDate column is in Date Time format, and there isn't any information about the time in this column, only the sale date. So we are going to convert the SaleDate as date, creating a new column.
